...
CREATE TABLE
    Domicili (
        ...
        CONSTRAINT FOREIGN KEY(propietari) REFERENCES Usuari(idUs)
    );
...
CREATE TABLE
    Venedor(
        ...
        CONSTRAINT FOREIGN KEY(idVen) REFERENCES Usuari(idUs)
    );

CREATE TABLE
    Comprador(
        idCompr int PRIMARY KEY,
        CONSTRAINT FOREIGN KEY(idCompr) REFERENCES Usuari(idUs)
    );
...
CREATE TABLE
    Repartidor(
        ...
        CONSTRAINT FOREIGN KEY(idRep) REFERENCES Usuari(idUs)
    );

CREATE TABLE
    Controlador(
        idContr int PRIMARY KEY,
        CONSTRAINT FOREIGN KEY(idContr) REFERENCES Usuari(idUs)
    );
